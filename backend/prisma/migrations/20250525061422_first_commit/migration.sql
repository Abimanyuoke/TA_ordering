...
CREATE TABLE `Menu` (
    ...
    `category` ENUM('BENIH_BIBIT', 'PUPUK_PESTISIDA', 'ALAT_PERLENGKAPAN', 'TANAH_MEDIA_TANAM', 'TANAMAN_HIAS', 'TANAMAN_BUAH', 'TANAMAN_SAYUR', 'TANAMAN_HERBAL', 'AKSESORIS_BERKEBUN', 'PAKET_BERKEBUN') NOT NULL DEFAULT 'BENIH_BIBIT',
