        ...
        <div className='w-full overflow-x-hidden'>
            ...
            <div className='py-10'>
                ...
                <div className='mt-6 pl-6 pr-[300px]'>
                    <Slider {...setting}>
                        {news.map((news) => (
                            <div className="px-2 flex-shrink-0" style={{ width: '500px' }} onClick={() => router.replace(`/user/news `)}>
                                <div className="relative group cursor-pointer overflow-hidden rounded-xl shadow-md hover:shadow-xl transition-all duration-300">
                                    <div className="aspect-video w-full" key={news.id}>
                                        <img
                                            className="w-full h-full rounded-lg shadow-lg object-cover"
                                            src={news.image.src}
                                            title={news.title} alt={news.title} />
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent flex items-end p-6">
                                            <div className="text-white">
                                                <h3 className="text-2xl font-bold mb-1">{news.title}</h3>
                                                <p className="text-sm opacity-90 italic">{news.description}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
